...
///   - timeout:
///   Amount of seconds to wait until the network loading indicator disappears. Pass `0` if you don't want to wait.
...
enum SnapshotError: Error, CustomDebugStringConvertible {
    ...
    var debugDescription: String {
        ...
        case .cannotAccessSimulatorHomeDirectory(let simHostHome):
            return "Can't prepare environment. Simulator home location is inaccessible. Does \(simHostHome) exist?"
        case .cannotRunOnPhysicalDevice:
